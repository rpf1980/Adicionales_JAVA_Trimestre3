...
public class Main
{
    ...
    //para poder hacer una copia con el nuevo incremento (backup_0008, backup_0022, backup_0123)
    ...
    public static void autoBacKup(String fichero)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    System.out.println("No se encontró ningún fichero con nombre backup");
                }
                else
                {
                    System.out.println("No se encontró el fichero buscado");
                }
            }
        }
        catch (Exception e)
